...
const CategoryList = ({ load, setLoad }) => {
  let CatData;
  CatData = useGetCategoriesQuery();

  const Cat = CatData?.data
    ?.filter((item) => item?.image !== "https://placeimg.com/640/480/any")
    .filter((item) => item?.name !== "  ")
    .filter((item) => item?.name !== "Animals")
    .filter((item) => item?.name !== "dummy");
          ...
          >
            ...
            >
              <Image
                ...
                objectFit={"cover"}
                src={
                  "https://i.pinimg.com/564x/cd/12/b6/cd12b6abe71866fd0d989ba932ec2f94.jpg"
                }
              />
              <Text
                color={"blue.900"}
            ...
            {Cat?.map((data) => {
              return (
                ...
                >
                  ...
                  <Image
                    fallback={
                      <Skeleton roundedTop={"lg"} w={"100%"} maxH={"83%"} />
                    }
                    bg={"blackAlpha.800"}
                    roundedTop={"lg"}
                    w={"100%"}
